			...
			<div class="card-body">
                <table class="w-100 table table-condensed table-bordered">
					<tbody>
                        ...
                        <tr class="<?= $_user->niveau >= 5 && $_user->niveau < 10 ? 'bg-success text-white' : '' ?>"><td class="font-weight-bold h5">Or</td></tr>
                        <tr class="<?= $_user->niveau >= 10 ? 'bg-success text-white' : '' ?>"><td class="font-weight-bold h5">Diament</td></tr>
                    </tbody>
				</table>
			</div>
		</div>
